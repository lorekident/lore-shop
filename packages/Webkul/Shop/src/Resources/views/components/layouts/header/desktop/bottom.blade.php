...
<div class="flex min-h-[78px] w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] max-1180:px-8" style="background:#faef06;">
    <!--
    ...
    <div class="flex items-center gap-x-10 max-[1180px]:gap-x-5" >
        ...
        >
            <img
                ...
                width="60" height="60" alt="{{ config('app.name') }}"
            >
        </a>
        ...
        >
            ...
            >
                <span>
                    <a
                        :href="category.url"
                        class="inline-block px-5 uppercase text-gray-600 font-semibold"
                    >
                        @{{ category.name }}
                    </a>
                </span>
